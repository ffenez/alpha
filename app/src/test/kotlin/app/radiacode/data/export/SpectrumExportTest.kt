...
class SpectrumExportTest {
    ...
    fun `file name carries a sortable stamp`() {
        ...
        assertEquals("radiacode-20260809-123045.xml", SpectrumExport.fileName(at, "xml", zone))
        assertEquals("radiacode-20260809-123045.n42", SpectrumExport.fileName(at, "n42", zone))
    }
