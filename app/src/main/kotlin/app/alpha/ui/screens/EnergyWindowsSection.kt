        ...
        Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    // Числа диапазонов в свёрнутой строке нет вовсе: голая
                    // цифра под заголовком ничего не сообщала — сколько их,
                    // видно сразу, как только строку раскрыли, а до раскрытия
                    // это не тот вопрос, с которым сюда приходят.
                }
