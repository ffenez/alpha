...
object BackupRu : BackupStrings {
    ...
    override fun stageName(stage: BackupStage): String = when (stage) {
        ...
        BackupStage.ENVIRONMENT -> "условия"
        BackupStage.STATIONS -> "станции съёмки"
        BackupStage.TEMPLATES -> "шаблоны спектров"
...
object BackupEn : BackupStrings {
    ...
    override fun stageName(stage: BackupStage): String = when (stage) {
        ...
        BackupStage.ENVIRONMENT -> "conditions"
        BackupStage.STATIONS -> "survey stations"
        BackupStage.TEMPLATES -> "spectrum templates"
