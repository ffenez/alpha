...
interface Strings {
    ...
    /**
     * Подпись риски своего уровня на шкале места.
     *
     * Обозначение, а не слово: на рабочем экране «порог» — техническое слово о
     * настройке, а не о том, что видно, и на графике та же риска давно
     * подписана «L1». Одна метка на оба места читается как одна величина;
     * само число живёт в настройках, а шкала отвечает «где он относительно
     * обычного».
     */
    val scaleThresholdTick: String
