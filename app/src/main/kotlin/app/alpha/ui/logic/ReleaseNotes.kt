...
object ReleaseNotes {
    ...
    fun notes(s: ReleaseStrings = ReleaseRu): List<ReleaseNote> = listOf(
        ReleaseNote("0.70.0", s.v0700Title, s.v0700Summary),
        ReleaseNote("0.69.0", s.v0690Title, s.v0690Summary),
        ReleaseNote("0.68.0", s.v0680Title, s.v0680Summary),
        ReleaseNote("0.67.0", s.v0670Title, s.v0670Summary),
        ReleaseNote("0.66.0", s.v0660Title, s.v0660Summary),
        ReleaseNote("0.65.0", s.v0650Title, s.v0650Summary),
        ReleaseNote("0.64.0", s.v0640Title, s.v0640Summary),
        ReleaseNote("0.63.0", s.v0630Title, s.v0630Summary),
        ReleaseNote("0.62.0", s.v0620Title, s.v0620Summary),
        ReleaseNote("0.61.0", s.v0610Title, s.v0610Summary),
        ReleaseNote("0.60.0", s.v0600Title, s.v0600Summary),
        ReleaseNote("0.59.0", s.v0590Title, s.v0590Summary),
        ReleaseNote("0.58.0", s.v0580Title, s.v0580Summary),
        ReleaseNote("0.57.0", s.v0570Title, s.v0570Summary),
        ReleaseNote("0.56.0", s.v0560Title, s.v0560Summary),
        ReleaseNote("0.55.0", s.v0550Title, s.v0550Summary),
        ReleaseNote("0.54.0", s.v0540Title, s.v0540Summary),
        ReleaseNote("0.53.0", s.v0530Title, s.v0530Summary),
        ReleaseNote("0.52.0", s.v0520Title, s.v0520Summary),
        ReleaseNote("0.51.0", s.v0510Title, s.v0510Summary),
