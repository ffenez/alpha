...
sealed interface SpectrumScale {
     ...
     * переход от края ползунка непрерывен.
     */
    ...
    data object Log : SpectrumScale {
        ...
        /**
         * Тонкая сетка внутри декады: 2·10ᵏ … 9·10ᵏ. Без неё положение внутри
         * декады неразличимо: 30 и 80 попадают в одно место между
         * подписанными делениями. Линии тоньше основных.
         */
