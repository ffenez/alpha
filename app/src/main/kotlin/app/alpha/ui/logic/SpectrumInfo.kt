...
/**
 * Глубина ответа: сначала ЧТО это значит, потом ПОЧЕМУ приложение так решило,
 * и только потом КАК посчитано. Уровни не смешиваются в одном разделе.
 */
 ...
 *
 * Чистая сборка: состав зависит от того, что есть на экране (курсор в
 * полноэкранном режиме, вход в него с вкладки, диагностика), и проверяется
 * тестом.
 */
object SpectrumInfo {
