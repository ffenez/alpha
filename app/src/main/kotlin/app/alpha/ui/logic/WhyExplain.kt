...
data class WhyLine(
    ...
    val value: String,
    /**
     * Заголовок группы, к которой относится строка; null — строка продолжает
     * предыдущую группу. Разбор из десятка строк без групп читается как
     * список чисел, а вопросы у пришедшего сюда разные: что сейчас, с чем
     * сравнивают, насколько уверенно и что вообще было бы замечено.
     */
