...
object NetworkIdentity {
    ...
    /**
     * Разделитель области хеширования.
     *
     * Строка НЕ переименована вместе с приложением намеренно: она входит в
     * хеш, и смена буквы превратила бы все сохранённые отпечатки сетей в
     * чужие — профили перестали бы узнавать свои места, а восстановленная
     * копия принесла бы отпечатки, которые уже никогда не совпадут. Это
     * техническая метка версии алгоритма, а не название продукта.
     */
