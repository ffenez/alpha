...
object AlgorithmVersions {
    ...
    /**
     * Multi-line isotope hints ([IsotopeMatcher]). Экран Спектра их больше не
     * показывает — вердикты даёт движок доказательств ([PEAK_EVIDENCE]);
     * версия остаётся 1, потому что математика матчера не менялась и старые
     * сохранённые результаты ссылаются на неё.
     */
