...
object NuclideInfoLibrary {
    ...
    fun all(s: NuclideStrings = NuclideRu): List<Nuclide> = listOf(
        ...
        Nuclide(
            symbol = "Ba-133",
            name = s.ba133Name,
            halfLife = s.ba133HalfLife,
            decay = s.ba133Decay,
            origin = NuclideOrigin.ARTIFICIAL,
            chain = null,
            lines = listOf(
                NuclideGammaLine(356.0f, 62.1f),
                NuclideGammaLine(81.0f, 34.1f),
                NuclideGammaLine(302.9f, 18.3f),
                NuclideGammaLine(383.9f, 8.9f),
                NuclideGammaLine(276.4f, 7.2f),
            ),
            everyday = s.ba133Everyday,
            confirmation = s.ba133Confirmation,
        ),
        Nuclide(
            symbol = "Co-57",
            name = s.co57Name,
            halfLife = s.co57HalfLife,
            decay = s.co57Decay,
            origin = NuclideOrigin.ARTIFICIAL,
            chain = null,
            lines = listOf(
                NuclideGammaLine(122.1f, 85.6f),
                NuclideGammaLine(136.5f, 10.7f),
            ),
            everyday = s.co57Everyday,
            confirmation = s.co57Confirmation,
        ),
        Nuclide(
            symbol = "Tc-99m",
            name = s.tc99mName,
            halfLife = s.tc99mHalfLife,
            decay = s.tc99mDecay,
            origin = NuclideOrigin.ARTIFICIAL,
            chain = null,
            lines = listOf(NuclideGammaLine(140.5f, 89.1f)),
            everyday = s.tc99mEveryday,
            confirmation = s.tc99mConfirmation,
        ),
        Nuclide(
            symbol = "Na-22",
            name = s.na22Name,
            halfLife = s.na22HalfLife,
            decay = s.na22Decay,
            origin = NuclideOrigin.ARTIFICIAL,
            chain = null,
            lines = listOf(NuclideGammaLine(1274.5f, 99.9f)),
            everyday = s.na22Everyday,
            confirmation = s.na22Confirmation,
        ),
        Nuclide(
            symbol = "Ir-192",
            name = s.ir192Name,
            halfLife = s.ir192HalfLife,
            decay = s.ir192Decay,
            origin = NuclideOrigin.ARTIFICIAL,
            chain = null,
            lines = listOf(
                NuclideGammaLine(316.5f, 82.9f),
                NuclideGammaLine(468.1f, 47.8f),
                NuclideGammaLine(308.5f, 29.7f),
                NuclideGammaLine(296.0f, 28.7f),
                NuclideGammaLine(604.4f, 8.2f),
                NuclideGammaLine(612.5f, 5.3f),
                NuclideGammaLine(588.6f, 4.5f),
                NuclideGammaLine(484.6f, 3.2f),
            ),
            everyday = s.ir192Everyday,
            confirmation = s.ir192Confirmation,
        ),
        Nuclide(
            symbol = "Eu-152",
            name = s.eu152Name,
            halfLife = s.eu152HalfLife,
            decay = s.eu152Decay,
            origin = NuclideOrigin.ARTIFICIAL,
            chain = null,
            lines = listOf(
                NuclideGammaLine(121.8f, 28.5f),
                NuclideGammaLine(344.3f, 26.6f),
                NuclideGammaLine(1408.0f, 20.9f),
                NuclideGammaLine(964.1f, 14.5f),
                NuclideGammaLine(1112.1f, 13.7f),
                NuclideGammaLine(778.9f, 12.9f),
                NuclideGammaLine(1085.9f, 10.1f),
                NuclideGammaLine(244.7f, 7.6f),
                NuclideGammaLine(867.4f, 4.2f),
            ),
            everyday = s.eu152Everyday,
            confirmation = s.eu152Confirmation,
        ),
        Nuclide(
            symbol = "Eu-154",
            name = s.eu154Name,
            halfLife = s.eu154HalfLife,
            decay = s.eu154Decay,
            origin = NuclideOrigin.ARTIFICIAL,
            chain = null,
            lines = listOf(
                NuclideGammaLine(123.1f, 40.4f),
                NuclideGammaLine(1274.4f, 34.9f),
                NuclideGammaLine(723.3f, 20.1f),
                NuclideGammaLine(1004.7f, 17.9f),
                NuclideGammaLine(873.2f, 12.1f),
                NuclideGammaLine(996.3f, 10.5f),
            ),
            everyday = s.eu154Everyday,
            confirmation = s.eu154Confirmation,
        ),
        Nuclide(
            symbol = "Ac-228",
            name = s.ac228Name,
