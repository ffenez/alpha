...
object FoodScreening {
     ...
     * низкофоновом счёте. В самом выводе он не участвует (там работает
     * критерий `AbAnalysis`) и отвечает на вопрос «что было бы видно», поэтому
     * взят строже вердиктного 2σ.
     */
