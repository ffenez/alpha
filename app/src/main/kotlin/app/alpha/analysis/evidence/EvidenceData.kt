 ...
 *
 * Отличается от [app.alpha.analysis.GammaLine] тем, что несёт provenance и
...
data class ObservedPeak(
    ...
    /** Нетто / σ(нетто) — то же определение, что в [app.alpha.analysis.PeakDetection]. */
    ...
    companion object {
         ...
         * которое посчитала [app.alpha.analysis.PeakDetection] по формуле
