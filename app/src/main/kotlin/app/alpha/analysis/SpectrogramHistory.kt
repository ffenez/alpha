...
object SpectrogramBinning {
    ...
    /**
     * Идентификатор схемы разбиения полос. Записи разных схем не
     * складываются: границы полос — часть смысла счёта.
     */
...
object SpectrogramHistory {
     ...
     * **Инженерный параметр хранения**: неделя — предел, за которым
