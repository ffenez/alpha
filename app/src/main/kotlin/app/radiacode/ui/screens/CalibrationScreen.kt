...
import app.radiacode.analysis.CalibrationDataset
import app.radiacode.analysis.EnergyCalibration
import app.radiacode.analysis.RadonTrend
import app.radiacode.analysis.evidence.BackgroundCalibration
import app.radiacode.analysis.evidence.CalibrationAccumulation
import app.radiacode.analysis.evidence.CalibrationReport
import app.radiacode.analysis.evidence.SqrtResolution
import app.radiacode.analysis.evidence.AcceptedResolution
import app.radiacode.analysis.evidence.ResolutionFitOutcome
...
import app.radiacode.ui.text.CalibrationStrings
...
suspend fun loadCalibration(graph: AppGraph): CalibrationModel {
    ...
    val resolution662 = connected?.info?.model?.peakResolution662
        ?: app.radiacode.analysis.PeakDetection.RESOLUTION_662
    ...
    Section(s.resolutionTitle, note = s.extrapolationNote) {
        ...
        val state = when {
            ...
            model.deviceSerial != null && accepted.deviceSerial != null &&
                ...
                date = app.radiacode.ui.logic.HistoryFormat.day(accepted.acceptedAtMillis),
...
@Composable
private fun LineRow(row: app.radiacode.ui.logic.CalibrationLineRow) {
    val colors = LocalAppColors.current
    val type = LocalAppTypography.current
    Row(modifier = Modifier.fillMaxWidth()) {
