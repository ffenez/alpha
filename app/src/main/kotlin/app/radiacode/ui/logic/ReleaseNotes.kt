...
object ReleaseNotes {
    ...
    val all: List<ReleaseNote> = listOf(
        ReleaseNote(
            date = "12.08.2026",
            title = "Точнее в терминах, чище на экране",
            lines = listOf(
                ...
                "Отладочный отчёт теперь описывает и прибор: модель, формат спектра, " +
                    "калибровку, причину отказа связи, пропуски и переподключения.",
