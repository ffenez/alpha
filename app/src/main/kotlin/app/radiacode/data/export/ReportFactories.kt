...
import app.radiacode.data.export.html.ComparisonReport
import app.radiacode.data.export.html.ReportComparison
import app.radiacode.data.export.html.ReportEn
import app.radiacode.data.export.html.ReportEvent
import app.radiacode.data.export.html.ReportRoutePoint
import app.radiacode.data.export.html.ReportRu
import app.radiacode.data.export.html.ReportRun
import app.radiacode.data.export.html.ReportSeries
import app.radiacode.data.export.html.ReportStrings
import app.radiacode.data.export.html.RoutePrivacy
import app.radiacode.data.export.html.RouteReport
import app.radiacode.data.export.html.SessionReport
...
object ReportFactories {
    ...
    fun experiment(
        ...
        zone: ZoneId = ZoneId.systemDefault(),
        nowMillis: Long = System.currentTimeMillis(),
    ): app.radiacode.data.export.html.ExperimentReport {
        val s = strings(language)
        val ru = language != AppLanguage.EN
        return app.radiacode.data.export.html.ExperimentReport(
    ...
    fun experimentJson(
        ...
        val w = Json.Writer(out)
        w.beginObject()
            .field("type", "radiacode-experiment")
