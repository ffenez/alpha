...
data class TrackSessionEntity(
    ...
    /**
     * Запись оборвалась, а не была остановлена человеком: приложение убили,
     * телефон выключился, служба упала. Такой маршрут закрывается по последней
     * точке при следующем запуске и в журнале назван прерванным — иначе он
     * вечно значился бы идущим.
     */
