...
data class AdmissionInput(
    /** Condition 1 — [app.radiacode.data.db.ProfileEntity.baselineLearning]. */
    val profileLearningEnabled: Boolean,
    /** Condition 2 — see [app.radiacode.context.MeasurementContext.isReliable]. */
 ...
 *    ([app.radiacode.ui.logic.Freshness.STALE_AFTER_SECONDS] = 10 s), so what
