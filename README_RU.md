...
<p align="center">
  Android-приложение для дозиметров RadiaCode.
</p>
...
Официальное приложение показывает, что прибор видит сейчас: показания, спектр,
спектрограмму, карту с треком. Alpha добавляет к этому память места — сравнение
с тем, что здесь было раньше, статистический критерий вместо глазомера и предел
чувствительности, когда различия не видно. На официальной странице возможностей
такого нет, но это не доказывает, что этого нет в самом приложении.
